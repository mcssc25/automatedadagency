...
- SQLite DB (`crm.db`) contains 362 brokerage profiles, 630 offices, 21,702 agent roster contacts (including boutique and large brand agents synced from CSV lists in production), and 9 outreach campaigns.
