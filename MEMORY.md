...
- Realtor scrapes should complete with warnings when no public individual agent emails are found; do not let long fallback calls make the UI spin indefinitely. Bounded fallback fix deployed in commit `b0c92e2`; brokerage-roster-first update is pending deployment on 2026-07-02.
