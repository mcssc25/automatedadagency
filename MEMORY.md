...
- OpenRouter provider code is deployed live, but production currently reports `openRouter.configured=false` until `OPENROUTER_API_KEY` and `OPENROUTER_ENABLED=true` are added to `/opt/ad-agency-autopilot/.env`.
