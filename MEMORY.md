...
- Realtor scrapes should complete with warnings when no public individual agent emails are found; do not let long fallback calls make the UI spin indefinitely. Bounded fallback fix deployed in commit `b0c92e2`; brokerage-roster-first update deployed in commit `649b399`; Rob Smith/privacy cleanup DB backup: `/opt/ad-agency-autopilot/data/backups/lead-cleanup-20260702T173550Z-rob-smith-privacy`.
