...
- Realtor scrapes should complete with warnings when no public individual agent emails are found; do not let long Gemini fallback calls make the UI spin indefinitely. Bounded fallback fix deployed in commit `b0c92e2`; VPS backup: `/opt/ad-agency-autopilot/data/backups/deploy-20260702T120757Z-bound-realtor-fallback`.
